...
export const sleepRecordSourceEnum = pgEnum("source", ["obsidian", "samsung_health"]);
...
export type SleepRecordColumns = keyof ReturnType<typeof getTableColumns<typeof sleepRecordsTable>>;
