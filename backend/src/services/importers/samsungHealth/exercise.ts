...
export class SamsungHealthExerciseImporter extends BaseSamsungHealthImporter<NewHeartRate> {
  override sourceId = "samsung-health-export-exercise-v1";
  override destinationTable = "exercises/exercises_measurements";
  override entryDateKey = "com.samsung.health.exercise.start_time";
