...
export function Table<T>(props: TableProps<T>) {
  ...
  const { data, columns, getRowKey, isLoading = false, page, limit, total, onNextPage, onPrevPage } = props;
  ...
  return (
    ...
    >
      ...
      {isNotNill(page) && isNotNill(limit) && isNotNill(total) && isNotNill(onNextPage) && isNotNill(onPrevPage) ? (
