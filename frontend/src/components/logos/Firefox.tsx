...
export function FirefoxLogo(props: { width?: number; height?: number }) {
  return (
    <svg
      ...
      {...props}
    >
      <linearGradient id="a" x1={0.898} x2={0.066} y1={0.155} y2={0.931}>
      ...
      <linearGradient id="l" x1={0.888} x2={0.18} y1={0.151} y2={0.835}>
